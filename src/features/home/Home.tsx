...
export const Home: React.FC = () => {
    ...
    return (
        <section id="home" className="flex flex-col md:flex-row items-center justify-center min-h-[80vh] px-8 md:px-16 gap-12 max-w-6xl mx-auto">
            ...
            <div className="w-64 h-64 md:w-80 md:h-80 flex-shrink-0">
                ...
                {bio.linkedin && <a href={bio.linkedin} target="_blank" rel="noreferrer" className="hover:text-red-800 transition-colors"><FaLinkedin size={20} color="#000" /></a>}
            ...
            <div className="flex flex-col items-start text-left">
                ...
                Hi, My name is <span className="text-blue-900">Ritik Lal Shrestha</span>
                </h1>
                ...
                <a href="/cv.pdf" download className="px-6 py-2 border border-gray-300 text-gray-700 rounded text-sm font-bold tracking-wide hover:bg-gray-50 transition-colors">
                    VIEW MY RESUME
                </a>
